<html>
   ...
   <link rel="shortcut icon" type="image/x-icon" href="picture/hotel.png" /> 
    ...
    <img src='picture/hotel.jpg' alt='Image Error' width=100% height='500'><br>
       <h1 style= "font-family: Arial, Helvetica, sans-serif; color: #2d545e;">   &nbsp;&nbsp;&nbsp; <i class="fa fa-building" aria-hidden="true"></i>&nbsp;The Luxurious Hotel, Pune.</h1><br>
         <div class='intro'> 
         <p>
             <B> Overview</B><br>This ornate, palatial tribute to Southern India's greatest empires -The Luxurious Hotel ,Pune - overlooks verdant foliage in the heart of Chennai. This luxury hotel offers one of the largest banqueting facilities in India, 10 award winning F&B outlets, signature wellness experiences and more.<br>

 It embodies the highest standards in Indian hospitality balanced with elegant restraint in a prime property with distinct personality.<br><b>The passific has 522 rooms and 78 luxuriously appointed service apartments- collectively its 600 spacious guest rooms, suites and luxury service apartments,</b> are the epitome of Indian grace and style, expertly delegated with thoughtful amenities.The Luxurious Hotel ,Pune meets the needs of both the business traveller on the move as well as the bespoke requirements of the destination connoisseur.</p>
             <p><B>Ideal Location</B><br>

The delights of this luxurious hotel are varied. As a fascinating throwback to a vibrant period in Indian history, The Luxurious Hotel ,Pune stands for timeless beauty and luxury. Built in the midst of the business hub of Guindy and located on Mount Road,The Luxurious Hotel ,Pune is within close proximity to many key areas of Chennai and is just 8 km away from the domestic and international airport which serves as an ideal destination for both business and leisure sojourns. The well-connected roads and transportation system enable easy accessibility to commercial points and key areas in the city. </p>
...
Towering facades and flowing architecture are leaves taken from the aesthetics of the Cholas, an ancient dynasty that made a deep impact on many regions within and outside of this country. From the shores of the Bay of Bengal to that of South Asian borders of Malaysia, China and Sri Lanka among others, the Cholas have influenced art, architecture and culture from their time to now. Impeccably carved temples, bronze sculptures of unparalleled beauty and keen attention to detail are aesthetics that continue to influence us till now.
        ...
        <div class="black">
           ...
           <div class='home-book'> <label>City/Destination/Hotel<br>The Luxurious Hotel, Pune</label></div>
        ...
        <div class='three'>
            ...
            <p>Ten distinct dining destinations featuring Indian & international cuisine along with some of the world's most well appreciated and prized beverages.</p>
              ...
              <div class='hotel-image-detail'><img class='img' src='picture/gym.jfif' alt='Image Error' width='350px' height='200px'>
            ...
            <div class='three'>
              <div class='hotel-image-detail'><img class='img' src='picture/summing.jfif' alt='Image Error' width='350px' height='200px'>
            ...
            <p>Capture a lifetime of great memories. Includes Wi-Fi, Breakfast and more</p>
              ...
              <div class='hotel-image-detail'><img class='img' src='picture/away.jfif' alt='Image Error' width='350px' height='200px'>
     ...
     <div class='split-left'>
        <img class='home-image' src='picture/facility.jpg' alt='image not found' height="500" width="850">
        </div>
        <div class='split-right'>
            ...
            <p >The Luxurious INTERNATIONAL Hotel is not merely the building but, above all, its people. We are a team of professionals, who can organise every event end-to-end.</p>
...
<div class='last'>
    ...
    <h2><i class="fa fa-phone" aria-hidden="true"></i> &nbsp;Contact</h2>
        <p style='font-size:20px'>The Luxurious Hotel,<br>
          No. 63, JM Road, <br>Pune - 411003<br>
...
Fax Number: +9144 2220 0300<br>
            ...
            Email Id: punehotel@hotels.in</p>
    ...
    <!--  <div class='contact-box'>
       <form id='mail'   class="mail-form"  method='post' action='contact.php'>
        ...
        <p><center><span>&hearts;</span>Made With Love by BG-20</center></p>
