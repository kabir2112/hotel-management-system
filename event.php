...
function goBack() {
  window.history.back();
            ...
            <center><h2 STYLE=' color:#2d545e;'> MEETINGS & EVENTS </h2></center> <br> 
                    <div class='intro'> 
                    <p>
                    The Luxurious Hotel ,Pune offers the most sophisticated spaces for hosting meetings, conferences, conventions, symposiums, banquets and performances with state of the art facilities and amenities. In fact, the facilities available at pasific, which include meeting rooms, banquet halls and conference rooms, are one of the largest and most comprehensive in India. Rajendra, with its enormous pillarless area, can be divided into 8 separate spaces with its own private pre-function area. On the other hand, the banquet area has its own exclusive entrance.
                    </p>
                     </div>
            <div class='hotel-image'>
            <div class='three'>
            <div class='hotel-image-detail'><img class='img' src='picture/m.jfif' alt='Image Error'  width='350px' height='200px'>
          ...
          <center>     <span >Venues - 8</span><br></center>
            ...
            <center><h2>CONFERENCE</h2></center>
                ...
                <div class='hotel-image-detail'><img class='img' src='picture/wedding.jfif' alt='Image Error' width='350px' height='200px'>
