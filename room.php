...
<div class='hotel-image'>
    ...
    <div class='three'>
    <div class='hotel-image-detail'><img class='img' src='picture/club.jfif' alt='Image Error'  width='350px' height='200px'>  
    ...
    <div class='hotel-image-detail'><img class='img' src='picture/classic.jfif' alt='Image Error'  width='350px' height='200px'>
    <form method='POST' action="rbooking.php" >
    ...
    <div class='hotel-image-detail'><img class='img' src='picture/superior.jfif' alt='Image Error' width='350px' height='200px'>
     <form method='POST' action="rbooking.php" >
    ...
    <div class='three'>
    <div class='hotel-image-detail'><img class='img' src='picture/family.jfif' alt='Image Error' width='350px' height='200px'>
         <form method='POST' action="rbooking.php" >
   ...
   <p class="des">Available:<?php  echo $count[3]; ?>/<?php  echo $total[3]; ?></p>
    ...
    <div class='hotel-image-detail'><img class='img' src='picture/presidential.jfif' alt='Image Error' width='350px' height='200px'>
         <form method='POST' action="rbooking.php" >
    ...
    <div class='hotel-image-detail'><img class='img' src='picture/bachelor.jfif' alt='Image Error' width='350px' height='200px'>
         <form method='POST' action="rbooking.php" >
   ...
   <p class="des">Available:<?php  echo $count[5]; ?>/<?php  echo $total[5]; ?></p>
    ...
    <div class='three'>
    <div class='hotel-image-detail'><img class='img' src='picture/luxury.jfif' alt='Image Error' width='350px' height='200px'>
         <form method='POST' action="rbooking.php" >
   ...
   <p class="des">Available:<?php  echo $count[6]; ?>/<?php  echo $total[6]; ?></p>
    ...
    <div class='hotel-image-detail'><img class='img' src='picture/dulex.jfif' alt='Image Error' width='350px' height='200px'>
         <form method='POST' action="rbooking.php" >
    ...
    <div class='hotel-image-detail'><img class='img' src='picture/super.jfif' alt='Image Error' width='350px' height='200px'>
         <form method='POST' action="rbooking.php" >
